		...
		<view v-if="insert || show" class="uni-calendar__content"
			...
			<view class="uni-calendar__header" :class="{'uni-calendar__header-mobile' :!insert}">
				...
				<picker mode="date" :value="date" fields="month" @change="bindDateChange">
					<text
						class="uni-calendar__header-text">{{ (nowDate.year||'') +' '+ Years +' '+ ( nowDate.month||'')+' '+ Months}}</text>
				</picker>
			...
			<view v-if="!insert" class="uni-date-changed uni-date-btn--ok">
				...
				<view class="uni-datetime-picker--btn" @click="confirm">{{Confirm}}</view>
			</view>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		computed: {
			...
			Years() {
				return t("uni-calender.YEAR")
			},
			Months() {
				return t("uni-calender.MONTH")
			}
		},
		created() {
			// 获取日历方法实例
