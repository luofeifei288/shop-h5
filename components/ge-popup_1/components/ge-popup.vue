<template>
	<view>
		...
		<view v-else-if="type==3">
			<view class="messBox">
				<view class="wrapBox">
					...
					<view class="btn"  @click="close">{{ $t('sys.know') }}</view>
				</view>
			</view>
		</view>
		...
		<view v-else-if="type==6">
			<view class="messBox">
				<view class="wrapBox" style="padding: 80rpx 30rpx 30rpx;">
					<text class="close6" @click="close">×</text>
					<view class="title" style="font-size: 42rpx;">{{title}}</view>
					<view class="desc">
						<rich-text :nodes="content"></rich-text>
					</view>
					<!-- <view class="btn"  @click="close">{{ $t('sys.know') }}</view> -->
